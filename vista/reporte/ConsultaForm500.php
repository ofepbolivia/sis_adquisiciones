...
<script>
    Phx.vista.ConsultaForm500=Ext.extend(Phx.gridInterfaz,{
        ...
        bedit : false,
        bdel : false,
        ActList:'../../sis_adquisiciones/control/Reporte/listarForm500',
        gruposBarraTareas:[
...

            {
                config: {
                    ...
                    renderer:function (value, p, record){
                        ...
                        if(fecha != '')
                            return String.format('{0}', "<div style='text-align:center;color: green'><b>"+fecha+"</b></div>");
                        else
                            return String.format('{0}', "<div style='text-align:center;color: red'><b>"+fecha+"</b></div>");
                    }
                },
                type: 'DateField',
