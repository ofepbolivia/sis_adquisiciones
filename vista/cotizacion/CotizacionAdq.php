    ...
    Phx.vista.CotizacionAdq = {
        ...
        constructor: function (config) {
            ...
            this.addButton('fin_registro', {
                ...
                tooltip: '<b>Finalizar</b><p>Finalizar registro de cotización</p>'
            });
            ...
            this.addButton('btnAdjudicar', {
                ...
                tooltip: '<b>Recomendar Todo</b><br/><b>Recomienda la adjudicación de todo lo disponible</b>'
            });
            ...
            this.addButton('btnSolApro', {
                ...
                tooltip: '<b>Solicitar Aprobación</b><p>Solicitar Aprobación del RPC</p>'
            });
            ...
            this.addButton('btnSendMail', {
                text: 'Sol. Cotización',
                iconCls: 'bemail',
                disabled: true,
                handler: this.onSendMail,
                tooltip: '<b>Solicitar Cotización</b><p>Solicita la cotización por correo al proveedor</p>'
            });

            this.addButton('btnSolCon', {
                text: 'Hab. Contr.',
                iconCls: 'bemail',
                disabled: true,
                handler: this.onSolContrato,
                tooltip: '<b>Habilitar Contrato</b><p>Si tiene habilitado los contratos en esta cotización, antes de armar el plan de pago pasará al área legal</p>'
            });
                    ...
                    if (reg.ROOT.datos.num_estados == 1 && (reg.ROOT.datos.num_funcionarios == 1 || reg.ROOT.datos.num_funcionarios == 0)) {
                        ...
                        Ext.Ajax.request({
                            ...
                            params: {
                                ...
                                obs: 'Se solicita  la revisión de la Cotización de la solicitud de compra ' + this.DataSelected.numero
                            },
                            success: this.successSinc,
                            failure: this.conexionFailure,
                            timeout: this.timeout,
        ...
        onSendMail: function () {
            ...
            Ext.Ajax.request({
                ...
                params: {
                    id_cotizacion: rec.data.id_cotizacion,
