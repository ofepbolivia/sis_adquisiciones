...
<script>
    Phx.vista.CotizacionDet = Ext.extend(Phx.gridInterfaz, {
        ...
        constructor: function (config) {
            ...
            this.addButton('adjudicar_det', {
                text: 'Recomendar Item',
                iconCls: 'bchecklist',
                disabled: true,
                handler: this.adjudicar_det,
                tooltip: '<b>Adjudicar</b><p>Permite adjudicar de manera parcial</p>'
            });
        ...
        Atributos: [
            ...
            },
            {
                config: {
                    ...
                    fieldLabel: 'Total Solicitado (Ref.)',
                    allowBlank: true,
                    anchor: '80%',
                    gwidth: 120,
                    maxLength: 1245184,
                ...
                type: 'NumberField',
                filters: {pfiltro: 'total_solicitado', type: 'numeric'},
                id_grupo: 1,
                grid: true,
                form: false
            },
        ...
        fields: [
            ...
            'total_adjudicado', 'total_cotizado', 'total_solicitado'],
        sortInfo: {
        ...
        preparaMenu: function (n) {
            ...
            if (rec.data.tipo_reg == 'summary') {
                ...
                Phx.vista.CotizacionDet.superclass.preparaMenu.call(this);
            }
        },
        liberaMenu: function () {
