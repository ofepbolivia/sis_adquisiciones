...
?>
<script>
    Phx.vista.SolicitudModalidadVbPoa = {
        bedit:true,
        bnew:false,
        bsave:false,
        bdel:false,
        ...
        nombreVista: 'SolicitudModalidadVbPoa',
        ...
        constructor: function(config) {
            ...
            Phx.vista.SolicitudModalidadVbPoa.superclass.constructor.call(this,config);
        ...
        preparaMenu:function(n){
            ...
            var tb =this.tbar;
            Phx.vista.SolicitudModalidadVbPoa.superclass.preparaMenu.call(this,n);
        ...
        liberaMenu:function(){
            var tb = Phx.vista.SolicitudModalidadVbPoa.superclass.liberaMenu.call(this);
            if(tb){
                this.getBoton('sig_estado').disable();
                this.getBoton('ini_estado').disable();
                this.getBoton('ant_estado').disable();
        ...
        onButtonEdit:function() {
            ...
            Phx.vista.SolicitudModalidadVbPoa.superclass.onButtonEdit.call(this);
