...
/**
 * @package pXP
 * @file gen-SolicitudModalidades.php
 * @author  (maylee.perez)
...
?>
<script>
    Phx.vista.SolicitudModalidades = Ext.extend(Phx.gridInterfaz, {
        ...
        listener: {
            ...
            constructor: function (config) {
                ...
                Phx.vista.SolicitudModalidades.superclass.constructor.call(this, config);
                this.maestro = config;
                that = this;
                this.init();
                this.addBotones();
            ...
            ActList: '../../sis_adquisiciones/control/SolicitudModalidades/listarSolicitudModalidades',
            ...
            arrayDefaultColumHidden: ['id_fecha_reg', 'id_fecha_mod',
                ...
                'lugar_entrega', 'fecha_inicio', 'dias_plazo_entrega', 'posibles_proveedores', 'comite_calificacion', 'extendida', 'obs_presupuestos', 'tipo_modalidad'],
            ...
            preparaMenu: function (n) {
                ...
                Phx.vista.SolicitudModalidades.superclass.preparaMenu.call(this, n);
            ...
            liberaMenu: function () {
                var tb = Phx.vista.SolicitudModalidades.superclass.liberaMenu.call(this);
                if (tb) {
