              ...
              ELSE
                  ...
                  -- Laverificaion es sencilla por presupeusto y por partida
                   FOR v_registros in (SELECT
                                          ...
                                          p.codigo_cc)
                            LOOP
                                        /*comentado por breydi vasquez motivo consulta por demas y generaba error 01/12/2020
                                          select
                                                sd.id_centro_costo
                                            INTO
                                                v_id_centro_costo
                                          ...
                                          v_resp_pre = pre.f_verificar_presupuesto_partida ( v_registros.id_centro_costo,
                                                                    v_registros.id_partida,
                                                                    v_registros.id_moneda,
                                                                    v_registros.precio_ga);
